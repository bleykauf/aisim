"""Functions for simulating certain aspects of atom interferometers."""
...
def wavefront_simulation(t, wf, atoms, det):
    """
    Calculate the phase or gravity bias caused by wavfront abberrations.
    ...
    # calculate the imprinted phase for each "test atom" at each pulse. This is
